...
class Login(unittest.TestCase):
    def setParameters(self,  case_name, method, token, openid,student_name, result, code, msg):
        """
        set params
        :param case_name:
        :param method:
    ...
    #     print(sql)
    #     cursor_sql = configDB.executeSQL(sql,'李好')
    #     configDB.get_all(cursor_sql)
    def tearDown(self):
        """
    ...
    def checkResult(self):
        ...
        if self.info['code'] == 0:
            ...
            with open('E:/XYRGInterface/testCase/user/cookie.txt','w')as f:
